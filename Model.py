...
if __name__ == "__main__":
    ...
    plt.set_xlabel('Predicted probability of being in class 90th percentile')
    plt.set_xlabel('Precision for the percentile of each line')
    plt.plot(x25, y25, color='green')
    plt.plot(x50, y50, color='blue')
    plt.plot(x50, y50, color = 'red')
    plt.plot(x90, y90, color = 'black')
    plt.legend()
    plt.show()
